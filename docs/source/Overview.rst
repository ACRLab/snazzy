...
This already saves considerable ROM memory but most importantly, it means we can easily load individual movies in the RAM of a common computer (8~16 GB), without needing to use memory mapped files.
